...
def generate_data(N, mu, beta0, beta1, sigma2, S):
    ...
    plt.subplot(1, 2, 1)
    plt.hist(intercepts, bins=20, color='skyblue', edgecolor='black')
    plt.axvline(intercept, color='red', linestyle='--', linewidth=2, label=f'Observed Intercept: {intercept:.4f}')
    ...
    plt.subplot(1, 2, 2)
    plt.hist(slopes, bins=20, color='lightcoral', edgecolor='black')
    plt.axvline(slope, color='red', linestyle='--', linewidth=2, label=f'Observed Slope: {slope:.4f}')
    plt.xlabel('Slope')
    plt.ylabel('Frequency')
